...
// Initiale Version
// Version 1.1
// Datumsformatierung für Serialization/Deserialization hinzugefügt
// TriggerItem-FromXML Problem behoben
// Version 1.2
// System.Windows.Forms.Timer in System.Threading.Timer geändert
// ThreadSynchronisation Objekt eingeführt (_triggerTimer)
// -----------------------------------------------------------------------------
// Autor:        Lothar Perr
...
namespace TribalWars.Forms.External
{
    public class TaskScheduler
    {
        ...
        {
            _triggerTimer.Stop();
            for (var i = TriggerItems.Count - 1; i >= 0; i--)
                TriggerItems[i].RunCheck(DateTime.Now);
